...
$id= $_REQUEST["ep"];
$sql= "SELECT * FROM `registration_ajax` WHERE user_id='$id'";
...
<input type="text" name="uid" id="uid" value="<?php echo $result['user_id']?>" hidden><br>
Enter Address1: <input type="text" id="add1" value="<?php echo $result['address_1']?>"><br>
Enter Address2: <input type="text" id="add2" value="<?php echo $result['address_2']?>"><br>
