...
//print_r($result);
$_SESSION["oldimgpath"]=$result["image"];
?>
...
<form method="post" action="editaction.php" enctype="multipart/form-data">
	...
	Enter address2: <input type="text" name="add2" value="<?php echo $result['address_2']?>"><br>
	...
	?>
	Enter language: <input type="checkbox" name="language[]" value="Bengali" <?php if(in_array("Bengali", $langarray)){echo "checked";}?>>Bengali
